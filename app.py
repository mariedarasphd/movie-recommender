...
# Centered Logo
# --------------------------
st.markdown("<div style='text-align: center;'><img src='https://raw.githubusercontent.com/mariedarasphd/movie-recommender/main/mariedaraslogo.png' width='200'></div>", unsafe_allow_html=True)
...
# --------------------------
if search_movie:
    rec_df = rec_df[rec_df["If you like"].str.contains(search_movie, case=False, na=False)]
